...
# 3 "p11.s" 2
 ...
 ;CONFIG1L dir 300000h 20
  ...
  CONFIG FOSC=INTOSCIO_EC ;OSCILADOR INTERNO, ((PORTA) and 0FFh), 6, a COMO PIN, USB USA OSC EC
  CONFIG FCMEN=OFF ;DESHABILITDO EL MONITOREO DEL RELOJ
  CONFIG IESO=OFF
  ;CONFIG2L ((USTAT) and 0FFh), 2, a 300002H 38
  CONFIG PWRT=ON ;PWRT HABILITADO
  ;CONFIG ((RCON) and 0FFh), 0, a=OFF ;BROWN OUT RESET DESHABILITADO
  CONFIG BORV=3 ;RESET AL MINIMO VOLTAJE NO UTILZADO EN ESTE CASO
  CONFIG VREGEN=ON ;REULADOR DE USB ENCENDIDO
  ;CONFIG2H ((USTAT) and 0FFh), 2, a 300003H 1E
  CONFIG WDT=OFF ;WACH DOG DESHABILITADO
  CONFIG WDTPS=32768 ;TIMER DEL WATCHDOG
  ;CONFIG3H ((USTAT) and 0FFh), 2, a 300005H 81
  CONFIG CCP2MX=ON ;((PORTC) and 0FFh), 1, a MULTIPLEXADAS CON ((PORTC) and 0FFh), 1, a
  ...
  ;CONFIG4L ((USTAT) and 0FFh), 2, a 300006H 81
  ...
  ;CONFIG5L ((USTAT) and 0FFh), 2, a 300008H 0F
  ...
  ;CONFIG6L ((USTAT) and 0FFh), 2, a 30000AH 0F
  CONFIG WRT0=OFF ;BLOQUES NO PROTEGIDOS CONTRA ESCRITURA
  CONFIG WRT1=OFF
  CONFIG WRT2=OFF
  CONFIG WRT3=OFF

  ;CONFIG6H ((USTAT) and 0FFh), 2, a 30000BH A0
  ...
  ;CONFIG7L ((USTAT) and 0FFh), 2, a 30000CH 0F
  CONFIG EBTR0=OFF ;TABLAS DE LETURA NO PROTEGIDAS
  CONFIG EBTR1=OFF
  CONFIG EBTR2=OFF
  CONFIG EBTR3=OFF

  ;CONFIG7H ((USTAT) and 0FFh), 2, a 30000DH 40
...
_clear:
    CLRF PORTB, A ; Limpia PORTB (mostrar 0)
    CLRF counter, A ; Limpia contador
    MOVLW 0xFF
    MOVWF const, A
