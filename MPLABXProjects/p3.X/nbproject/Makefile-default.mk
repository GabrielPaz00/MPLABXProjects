...
SOURCEFILES_QUOTED_IF_SPACED=p3.s
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/p3.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/p3.o: p3.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/p3.o 
...
${DISTDIR}/p3.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/p3.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
