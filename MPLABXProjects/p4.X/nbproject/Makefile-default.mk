...
SOURCEFILES_QUOTED_IF_SPACED=p4.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/p4.o
POSSIBLE_DEPFILES=${OBJECTDIR}/p4.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/p4.o
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/p4.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/p4.o: p4.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/p4.o 
...
${DISTDIR}/p4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/p4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
