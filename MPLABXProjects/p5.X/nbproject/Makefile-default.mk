...
SOURCEFILES_QUOTED_IF_SPACED=p5.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/p5.o
POSSIBLE_DEPFILES=${OBJECTDIR}/p5.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/p5.o
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/p5.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/p5.o: p5.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/p5.o 
...
${DISTDIR}/p5.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/p5.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
