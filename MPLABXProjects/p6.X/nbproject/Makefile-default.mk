...
SOURCEFILES_QUOTED_IF_SPACED=p6.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/p6.o
POSSIBLE_DEPFILES=${OBJECTDIR}/p6.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/p6.o
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/p6.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/p6.o: p6.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/p6.o 
...
${DISTDIR}/p6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/p6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
