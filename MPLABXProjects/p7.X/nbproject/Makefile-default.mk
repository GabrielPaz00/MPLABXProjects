...
SOURCEFILES_QUOTED_IF_SPACED=p7.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/p7.o
POSSIBLE_DEPFILES=${OBJECTDIR}/p7.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/p7.o
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/p7.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/p7.o: p7.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/p7.o 
...
${DISTDIR}/p7.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/p7.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
