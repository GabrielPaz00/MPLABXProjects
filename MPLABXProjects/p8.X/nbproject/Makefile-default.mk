...
SOURCEFILES_QUOTED_IF_SPACED=p8.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/p8.o
POSSIBLE_DEPFILES=${OBJECTDIR}/p8.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/p8.o
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/p8.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/p8.o: p8.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/p8.o 
...
${DISTDIR}/p8.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/p8.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
