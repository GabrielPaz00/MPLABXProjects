...
SOURCEFILES_QUOTED_IF_SPACED=p9.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/p9.o
POSSIBLE_DEPFILES=${OBJECTDIR}/p9.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/p9.o
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/p9.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/p9.o: p9.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/p9.o 
...
${DISTDIR}/p9.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/p9.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
